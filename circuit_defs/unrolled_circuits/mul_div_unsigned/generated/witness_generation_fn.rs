    ...
    W::I32: Copy,
{
    ...
    let v_10 = v_4.widen();
    let v_11 = v_10.shl(16u32);
    let v_12 = v_3.widen();
    let mut v_13 = v_11;
    W::U32::add_assign(&mut v_13, &v_12);
    let v_14 = W::U32::split_widening_product(&v_9, &v_13).0;
    let v_15 = W::U32::constant(0u32);
    let v_16 = W::U32::equal(&v_13, &v_15);
    let v_17 = W::U32::constant(4294967295u32);
    let v_18 = W::U32::constant(134217727u32);
    let v_19 = WitnessComputationCore::select(&v_16, &v_18, &v_13);
    let v_20 = W::U32::div_rem_assume_nonzero_divisor(&v_9, &v_19).0;
    let v_21 = WitnessComputationCore::select(&v_16, &v_17, &v_20);
    let v_22 = WitnessComputationCore::select(&v_5, &v_14, &v_21);
    let v_23 = v_22.truncate();
    witness_proxy.set_witness_place_u16(20usize, v_23);
    let v_25 = v_22.shr(16u32);
    let v_26 = v_25.truncate();
    witness_proxy.set_witness_place_u16(21usize, v_26);
    let v_28 = W::U32::split_widening_product(&v_9, &v_13).1;
    let v_29 = W::U32::div_rem_assume_nonzero_divisor(&v_9, &v_19).1;
    let v_30 = WitnessComputationCore::select(&v_16, &v_9, &v_29);
    let v_31 = WitnessComputationCore::select(&v_5, &v_28, &v_30);
    let v_32 = v_31.truncate();
    witness_proxy.set_witness_place_u16(22usize, v_32);
    let v_34 = v_31.shr(16u32);
    let v_35 = v_34.truncate();
    witness_proxy.set_witness_place_u16(23usize, v_35);
}
#[allow(unused_variables)]
#[inline(always)]
fn eval_fn_5<
